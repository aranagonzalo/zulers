...
const Navbar = () => {
    ...
    const [isHoveredRecubrimientos, setIsHoveredRecubrimientos] =
        useState(false);
        ...
        <>
            ...
            <header className="fixed z-50 w-full flex-col bg-white hidden lg:flex">
                <nav className="w-full flex h-[26px] border-b border-[#efefef]">
                    <div className="flex w-1/4 bg-[#efefef] items-center justify-evenly border-r border-slate-300">
                ...
                <nav className="w-full flex h-[108px]">
                    <div className="w-[14%] items-center justify-center h-full">
                        <Link className="block relative h-full w-full" href="/">
                            <Image
                                styles={{ width: "auto" }}
                        ...
                        <div className="h-[54px] w-full">
                            <ul className="flex w-full h-full">
                                <Link
                                    ...
                                    className="w-1/3 h-full shadow-sm shadow-slate-200"
                                >
                                    <li className="h-full uppercase text-[11px] font-semibold text-slate-700 flex items-center justify-center p-2 cursor-pointer hover:bg-[#1f1f1f] hover:text-white">
                        ...
                        <div className="h-[54px] w-full">
                            <ul className="flex w-full h-full">
                                <div className="relative w-1/5 h-full shadow-sm shadow-slate-200 group hover:bg-[#068940] hover:text-white">
                                    <div
                                        className={`h-full uppercase text-[11px] font-semibold ${
                                            !isHoveredRecubrimientos
                                                ? "text-slate-700"
                                                : ""
                                        } flex items-center justify-center p-2 cursor-pointer whitespace-normal truncate`}
                                        onMouseEnter={() =>
                                            setIsHoveredRecubrimientos(true)
                                        }
                                        onMouseLeave={() =>
                                            setIsHoveredRecubrimientos(false)
                                        }
                                        onClick={() =>
                                            router.push(
                                                "/ergonarmor/recubrimientos-antiacidos"
                                            )
                                        }
                                    >
                                ...
                                <div className="relative w-1/5 h-full shadow-sm shadow-slate-200 group hover:bg-[#068940] hover:text-white">
                                    <div
                                        className={`h-full uppercase text-[11px] font-semibold ${
                                            !isHoveredRestauracion
                                                ? "text-slate-700"
                                                : ""
                                        } flex items-center justify-center p-2 cursor-pointer whitespace-normal truncate`}
                                        onMouseEnter={() =>
                                            setIsHoveredRestauracion(true)
                                        }
                                        onMouseLeave={() =>
                                            setIsHoveredRestauracion(false)
                                        }
                                        onClick={() =>
                                            router.push(
                                                "/ergonarmor/restauracion-de-metales"
                                            )
                                        }
                                    >
                                ...
                                <div className="relative w-1/5 h-full shadow-sm shadow-slate-200 group hover:bg-[#068940] hover:text-white">
                                    <div
                                        ...
                                        onMouseEnter={() =>
                                            setIsHoveredConcreto(true)
                                        }
                                        onMouseLeave={() =>
                                            setIsHoveredConcreto(false)
                                        }
                                        onClick={() =>
                                            router.push(
                                                "/ergonarmor/concreto-polimerico"
                                            )
                                        }
                                    >
                                        Concreto Polimérico
                                ...
                                <div className="relative w-1/5 h-full shadow-sm shadow-slate-200 group hover:bg-[#068940] hover:text-white">
                                    <div
                                        ...
                                        onMouseEnter={() =>
                                            setIsHoveredLosetas(true)
                                        }
                                        onMouseLeave={() =>
                                            setIsHoveredLosetas(false)
                                        }
                                        onClick={() =>
                                            router.push(
                                                "/ergonarmor/ladrillos-losetas-antiacidas"
                                            )
                                        }
                                    >
                                        Losetas Antiacidas
                                ...
                                <div className="relative w-1/5 h-full shadow-sm shadow-slate-200 group hover:bg-[#068940] hover:text-white">
                                    <div
                                        ...
                                        onMouseEnter={() =>
                                            setIsHoveredLiners(true)
                                        }
                                        onMouseLeave={() =>
                                            setIsHoveredLiners(false)
                                        }
                                        onClick={() =>
                                            router.push(
                                                "/ergonarmor/liners-termoplasticos"
                                            )
                                        }
                                    >
                        ...
                        {isMenuOpen && (
                            ...
                            >
                                <ul className="flex w-full text-sm font-medium justify-between items-center px-4 h-14 bg-[#efefef]">
                                    <li className="p-2 font-medium text-sm text-black">
                                        Nosotros
                                    </li>
                                    <ChevronDown
                                        color="black"
                                ...
                                {subMenuState.Nosotros && (
                                    <ul className="px-12 py-4 bg-[#efefef] font-medium text-sm items-center border-t-2 border-[#d9d9d9] text-black">
                                        <li className="border-b-[1px] text-sm p-3">
                                        ...
                                        <li className="border-b-[1px] text-sm p-3 flex items-center gap-4">
                                            <Mail
                                                color="#efefef"
                                                size={18}
                                                fill="text-black"
                                        ...
                                        <li className="mb-2 text-sm p-2 flex items-center gap-4">
                                            <Link
                                                target="_blank"
                                                href="https://www.linkedin.com/company/zulers-peru"
                                            >
                                ...
                                <ul className="flex w-full text-sm font-medium justify-between items-center px-4 bg-[#1f1f1f] h-14">
                                    <li className="p-2 uppercase font-medium text-sm text-white">
                                        Servicios
                                    </li>
                                    <ChevronDown
                                        color="white"
                                        onClick={() =>
                                            handleSubMenu("Servicios")
                                        }
                                    />
                                </ul>
                                {subMenuState.Servicios && (
                                    <ul className="px-12 py-4 bg-[#1f1f1f] font-medium text-sm items-center border-t-2 border-[#333]">
                                        <li className="uppercase text-sm text-white flex items-center p-3 border-b-[1px] border-[#333]">
                                            Diseño & construcción de pisos
                                        </li>
                                        <li className="uppercase text-sm text-white flex items-center p-3 border-b-[1px] border-[#333]">
                                            Recubrimiento de pisos
                                        </li>
                                        <li className="uppercase text-sm text-white flex items-center p-3">
                                            Impermeabilización
                                        </li>
                                    </ul>
                                )}
                                <ul className="flex w-full text-sm font-medium justify-between items-center bg-[#068940] h-14 px-4">
                                    <li className="flex flex-col items-center justify-center">
                                        ...
                                        <p className="text-[6px] font-semibold uppercase mt-[-2px] text-white">
                                            Distribuidor Exclusivo
                                        </p>
                                    </li>
                                    <ChevronDown
                                        color="white"
                                        onClick={() =>
                                            handleSubMenu("ErgonArmor")
                                        }
                                    />
                                </ul>
                                {subMenuState.ErgonArmor && (
                                    <ul className="px-12 py-4 bg-[#068940] font-medium text-sm items-center border-t-2 border-[#1f9553]">
                                        <li className="uppercase text-sm text-white flex items-center p-3 border-b-[1px] border-[#1f9553]">
                                            Recubrimientos Antiácidos
                                        </li>
                                        <li className="uppercase text-sm text-white flex items-center p-3 border-b-[1px] border-[#1f9553]">
                                            Restauración de Metales

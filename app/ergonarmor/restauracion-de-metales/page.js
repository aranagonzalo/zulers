        ...
        <main className="w-full flex flex-col pt-16 lg:pt-[132px]">
            <section className="w-full flex flex-col relative bg-black px-6 py-12 md:p-24 lg:p-28 justify-center">
                ...
                <p className="z-10 text-white/90 font-normal text-xl pb-24 w-full md:w-[85%]">
                    Sistemas de reconstrucción y protección de superficies
                    metálicas, equipos y maquinarias, que{" "}
            ...
            <section className="flex flex-col w-full items-center px-6 py-12 md:p-24 lg:p-32 relative">
                ...
                <p className="text-justify text-lg font-medium w-[75%] mb-4">
                    Cuando la{" "}
                    <span className="font-bold">corrosión y el desgaste </span>
                    amenazan el rendimiento de sus activos, es fundamental
                    contar con soluciones efectivas que ofrezcan una
                ...
                <p className="text-justify text-lg font-medium w-[75%] mb-10">
                    ...
                    <span className="font-bold">
                        reparación y restauración de maquinaria y equipos
                        metálicos
                    </span>
                    para las distintas exigencias mecánicas, químicas y/o
                    temperatura. Reduciendo al máximo los tiempos de
                    inactividad, con materiales de curado rápido, y de
